    ...
    <>
      <div className='main-div' style={{backgroundColor:"#0099ff", width:"100%", margin:"0", padding: "0", height: "50vh", textAlign: "center"}}>
        ...
        <div style={{ marginTop: "1rem" }}>
          <Link className="btn btn-success" to="/login" role="button" style={{ display: "inline-block", marginRight: "10px", color:"#212121", width:"150px" }}>Login</Link>
          <Link className="btn btn-success" to="/signup" role="button" style={{ display: "inline-block", color:"#212121", width:"150px" }}>Signup</Link>
        </div>
      </div>
